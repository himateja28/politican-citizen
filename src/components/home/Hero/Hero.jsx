    ...
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        <h1 className={styles.heroTitle}>
          <span className={styles.highlight1}>Bridging the Gap</span>:
          Empowering Conversations Between{" "}
          <span className={styles.highlight2}>Leaders</span> and{" "}
          <span className={styles.highlight3}>Citizens</span>
        </h1>
        <img
